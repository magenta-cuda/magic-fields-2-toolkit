    ...
    if ( isset( $_REQUEST['magic-fields-show-using-macro'] ) && $_REQUEST['magic-fields-show-using-macro'] === 'use macro' ) {
        ...
        add_action( 'wp_enqueue_scripts', function() {
            ...
            if ( file_exists( dirname( __FILE__ ) . "/css/search-results-table-$_REQUEST[post_type].css") ) {
                wp_enqueue_style( 'mf2tk_search_results_table', plugins_url( "css/search-results-table-$_REQUEST[post_type].css",
                  __FILE__ ) );
                ...
                wp_enqueue_style( 'mf2tk_search_results_table', plugins_url( "search-results-table-$_REQUEST[post_type].css",
                  __FILE__ ) );
            } else {
                wp_enqueue_style( 'mf2tk_search_results_table', plugins_url( 'css/mf2tk_search-results-table.css',
                  __FILE__ ) );
            }
        } );
